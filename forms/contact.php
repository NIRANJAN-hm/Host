...
$receiving_email_address = 'info@sriguruconstruction.com';
...
$domain = preg_replace('/[^A-Za-z0-9.-]/', '', $_SERVER['HTTP_HOST'] ?? 'sriguruconstructions.com');
$from = 'website@' . ($domain ?: 'sriguruconstructions.com');

$headers = [
    'From: Sri Guru Construction & Interiors Website <' . $from . '>',
    'Reply-To: ' . $name . ' <' . $email . '>',
    'MIME-Version: 1.0',
...
echo 'Unable to send your message right now. Please call +91 7795 444 954 or email info@sriguruconstruction.com. For WhatsApp delivery, configure CALLMEBOT_API_KEY on the server.';
